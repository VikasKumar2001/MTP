...
print("========================================")
print(" FINAL PHASE: ENCODING & VISUALIZATION")
print("========================================")
...
for filepath in stl_files:
    try:
        ...
        # Extract Base Data (Needed for visualizer renders)
        ...
        # Timed Descriptor Extraction (Needed for evaluation metrics)
        ...
        # ==========================================================
        latent_vector = fusion_wrapper.fuse(all_features)
